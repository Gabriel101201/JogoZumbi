...
public class PlayerMove : MonoBehaviour
{
    ...
    public CarControl controleCarro;
    public Transform saidaCarro;
    ...
    void Update()
    {
        ...
        if (Input.GetButtonDown("Fire2"))
        {
            ...
            {
                if (wantToOffBoard(out Transform mysterringWheel))
                {
                    sterringWeell = null;
            ...
            {
                if (wantToBoard(out Transform mysterringWheel))
                {
                    sterringWeell = mysterringWheel;
